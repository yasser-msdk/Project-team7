...
<body>
    <section id="banner">
        ...
        <div class="banner-text">
            ...
            <p><i>reviews and sumaries of some established or trending games in<br> all major platforms</i></p>
            <div class="banner-btn">
                <a href="fro.php"><span></span>sign up</a>
                <a href="log in.php"><span></span>sign in</a>
            </div>
        </div>
    </section>
...
<section id="service">
    ...
    <div class="service-box">
        <div class="single-service">
            ...
            <h4 class="u-product-control u-text u-text-3"><br>
                <a class="u-product-title-link" href="playstation.php">Playstation</a>
              </h4> 
        </div>
        <div class="single-service">
            ...
            <h4 class="u-product-control u-text u-text-3"><br>
                <a class="u-product-title-link" href="xbox.php">Xbox</a>
              </h4>
        </div>
        <div class="single-service">
            ...
            <h4 class="u-product-control u-text u-text-3"><br>
                <a class="u-product-title-link" href="pc.php">PC</a>
              </h4>
        </div>
        <div class="single-service">
            ...
            <h4 class="u-product-control u-text u-text-3"><br>
                <a class="u-product-title-link" href="nintendo.php">Nintendo</a>
              </h4>
        </div>
    </div>
...
<section id="footer">
    ...
    <div class="text">
        <h1>CONTACT US</h1>
        <p>e-mail:phantom_reviews@gmail.com <br> phone:+358 44 8952131 <br> if you wanna suggest a game you want us to cover feel free to do so here <a class="link" href="suggestion.php">suggestion box</a></p>
    </div>
</footer>
    </body>
</html>